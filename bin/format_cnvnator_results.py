...
#headers
print("#sample\tchrm\tstart\tend\tcnv\tsize\tnormalized_rd\te-val2\tq0", end="\n", file=o_file)
print("#sample\tchrm\tstart\tend\tcnv\tsize\tnormalized_rd\te-val2\tq0", end="\n", file=f_file)
...
for line in i_file:
	...
	if header_flag == 0 and line[0] == "#":
		...
		tmp_str = sample + "\t" + coordinates[0] + "\t" + coordinates[1].split("-")[0] + "\t" + coordinates[1].split("-")[1] + "\t" + type + "\t" + size + "\t" + str(nrd) + "\t" + eval2 + "\t" + q0
		print(tmp_str, end="\n", file=o_file)
