...
#headers
print("#sample\tchrm\tstart\tend\tcnv\tsize\tnormalized_rd\te-val2\tq0", end="", file=o_file)
print("#sample\tchrm\tstart\tend\tcnv\tsize\tnormalized_rd\te-val2\tq0"", end="", file=f_file)
